...
namespace jinowom\workflow\manager\models;
...
class Workflow extends ActiveRecord
{
    ...
    {
        return [
            [['id','name','name_cn'], 'required'],
            [['id', 'initial_status_id'], 'string', 'max' => 32],
            [['name','name_cn'], 'string', 'max' => 255],
    ...
    {
        return [
            'id' => Yii::t('app', '*流程名（由英文字符组成）'),
            'name' => Yii::t('app', '流程名英文'),
            'name_cn' => Yii::t('app', '流程名中文'),
            'initial_status_id_cn' => Yii::t('app', '初始状态中文名'),
            'initial_status_id' => Yii::t('app', '初始状态英文名'),
        ];
    }
